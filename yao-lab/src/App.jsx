...
export default function YaoLabHomepage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main>
        <section className="mx-auto grid max-w-6xl gap-10 px-6 pt-96 pb-10 md:grid-cols-[1.1fr_0.9fr] md:items-center" style={{backgroundImage: "linear-gradient(rgba(255,255,255,0.5), rgba(255,255,255,0.5)), url('/back1.jpg')", backgroundSize: "cover", backgroundPosition: "top"}}>
          <motion.div
            key={lang}
